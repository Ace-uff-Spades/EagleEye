...
public class Mavlink_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writeMavlinkFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } catch (ARMavlinkException | IOException e) {
    ...
    private void CreateFlightPlan() throws ARMavlinkException, IOException {
        Log.e(TAG, "Creating Flightplan");
        addToLogs("CREATING FLIGHTPLAN...");
    ...
    public void runMavlink(String filename) throws ARControllerException {
        ...
        //First check if flightplan is availiable
